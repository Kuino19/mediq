/**
 * MediQ AI Pre-Consultation Simulation Script
 * Babcock University - CS Final Year Project
 * Authors: Adebola Joshua Adedeji (22/0596) & Lawal John Ifedayo (22/0391)
 *
 * Simulates 50 patient profiles through the MediQ AI pipeline.
 * Calls Groq API directly (same model as the live app).
 *
 * Usage:  node src/simulate-mediq.mjs <GROQ_API_KEY>
 *    or:  set GROQ_API_KEY=... && node src/simulate-mediq.mjs
 */
...
function buildConversation(p) {
    ...
    return [
        { role: 'assistant', text: 'Hello! I am MediQ, your pre-consultation assistant. What brings you in today?' },
...
console.log(`\n=== MediQ Simulation — ${profiles.length} patients ===\n`);
    ...
    while (attempt < 3 && !success) {
        try {
            ...
            results.push({
                ...
                mediq_review_time_mins: profile.mediq_review_time_mins,
                time_saved_mins: profile.baseline_time_mins - profile.mediq_review_time_mins,
            });
